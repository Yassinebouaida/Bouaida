document.addEventListener('DOMContentLoaded', () => {
    ...
    // عند تحميل الصفحة، تحقق مما إذا كان هناك تاريخ ميلاد محفوظ
    ...
    calculateBtn.addEventListener('click', () => {
        ...
        // إخفاء النتائج القديمة وإظهار شاشة التحميل
        resultSection.classList.add('hidden');
        loader.classList.remove('hidden');

        // محاكاة عملية التحليل لإعطاء إحساس بالتشويق
        setTimeout(() => {
            ...
            if (zodiacSign) {
                // حفظ تاريخ الميلاد الحالي في LocalStorage
